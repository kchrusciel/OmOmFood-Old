...
-- Offers
insert into offer (id, city, created_date, description, event_date, file_name, owner_id, phone_number, price, quantity, title) values (null, 'Sosnowiec',  to_date ('2016-12-20 21:49:09','YYYY-MM-DD HH24:MI:SS'), 'Opis', to_date('2016-12-20 21:49:09','YYYY-MM-DD HH24:MI:SS'), 'test.png', 1, '500-600-700', 50, 4, 'Title');

-- Messages
insert into message (id, content, creation_date, is_read, offerid, owner, title) values (null, 'One ipsum dolor sit amet, consectetur adipiscing elit', to_date ('2016-12-20 21:49:09','YYYY-MM-DD HH24:MI:SS'), FALSE, 1, 1, 'title');
insert into message (id, content, creation_date, is_read, offerid, owner, title) values (null, 'One ipsum dolor sit amet, consectetur adipiscing elit', to_date ('2016-12-20 21:49:09','YYYY-MM-DD HH24:MI:SS'), FALSE, 1, 1, 'title');